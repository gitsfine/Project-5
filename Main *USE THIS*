...
public class Main {
    ...
    public static boolean startUserInput(Scanner s, MarketplaceClient m) { // GUI done
    ...
    public static boolean signupOrLogin(Scanner s, MarketplaceClient m) { // GUI done
        ...
        while (isActive) {
            ...
            switch (choiceNum) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    String output =  m.dashboardCustomerNumSales(promptDecending(s));
                    JOptionPane.showMessageDialog(null, output,
                            "Coffee Shop MarketPlace", JOptionPane.PLAIN_MESSAGE);
                    break;
                case 4:
                    output =  m.dashboardProductNumSales(promptDecending(s));
                    JOptionPane.showMessageDialog(null, output,
                            "Coffee Shop MarketPlace", JOptionPane.PLAIN_MESSAGE);
                    break;
                case 5:
    ...
    public static void createNewProduct(Scanner s, MarketplaceClient m, Store store) { // GUI done
        ...
        System.out.printf("%s", m.getProductList(store));
        if (!status) {
        ...
        while (isActive) {
            ...
            switch (choiceNum) {
                case 1:
                    ...
                    if (!(store.getName().equals("none"))) {
                        List<Product> products = store.getProducts();
                        shopFromProducts(s, m, products);
                    } else {
                        JOptionPane.showMessageDialog(null, "No stores have been created yet, sorry :(",
                                "Coffee Shop MarketPlace", JOptionPane.ERROR_MESSAGE);
                    }
                    break;
                case 2:
    ...
    public static Store listAllStores(Scanner s, MarketplaceClient m) { // GUI done
        ...
        if (!(stores.isEmpty())) {
            ...
            Store store = new Store("none", new Seller("NA", "NA", "NA"));
            return store;
        }
    }
    ...
    public static void searchForProduct(Scanner s, MarketplaceClient m) { // GUI done
        ...
        if (!(storeProducts.isEmpty())) {
            ...
            JOptionPane.showMessageDialog(null, "Nothing matches your search criteria :(", "===Cart===",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public static void viewCart(Scanner s, MarketplaceClient m) { // GUI done
        ...
        if (!(m.viewCart().isEmpty())) {
            ...
            JOptionPane.showMessageDialog(null, "Your cart is empty, try adding something!", "===Cart===",
                    JOptionPane.ERROR_MESSAGE);
    ...
    public static void shopFromProducts(Scanner s, MarketplaceClient m, List<Product> storeProducts) { // GUI done
        ...
        if (!(storeProducts.isEmpty())) {
            ...
            JOptionPane.showMessageDialog(null, "I'm sorry, this store does not have any products yet :(", "===Products===",
                    JOptionPane.ERROR_MESSAGE);
