...
public class mainProjectFour {
                    ...
                    if ((username == null)) {
                        ...
                        if (hasNumber && hasLetter) {
                            ...
                            for (int i = 0; i < m.users.size(); i++) {
                                if (username.equals(m.users.get(i).getUsername())) {
                                    alreadyTaken = true;
                                    break;
                                }
                            }
                ...
                do { //enter email
                    ...
                    if (email == null) {
                        ...
                        if (hasAtSign && hasDot) {
                            boolean alreadyTaken = false;
                            for (int i = 0; i < m.users.size(); i++) {
                                if (email.equals(m.users.get(i).getEmail())) {
                                    alreadyTaken = true;
                                    break;
                                }
                            }
    ...
    public static void createStore(Scanner s, Marketplace m) { // GUI done
        ...
        for (int i = 0; i < m.stores.size(); i++) {
            if (m.stores.get(i).getName().equals(storeName)) {
                alreadyTaken = true;
                break;
            }
        }
    ...
    public static Store listAllStores(Scanner s, Marketplace m) { // GUI done
    ...
    public static void viewCart(Scanner s, Marketplace m) { // GUI done
        ...
        if (!((m.viewCart() == null) || m.viewCart().isEmpty())) {
